...
@else
    @php
        ...
        $isGrouped = $action->getGroup() instanceof \Filament\Actions\ActionGroup;
    ...
    >
        ...
        <x-dynamic-component
            ...
            x-on:click.prevent.stop="process(); $wire.{!! $mountHandler !!}; $wire.{!! $confirmHandler !!}().finally(() => { disarm(); closeDropdown() })"
            type="button"
        >
